...
(function (root, factory) {
  ...
  var module = angular
    ...
    .factory("RzSlider", [
      ...
      "rzThrottle",
      "$rootScope",
      function ($timeout, $document, $window, $compile, RzSliderOptions, rzThrottle, $rootScope) {
        "use strict";
        ...
        Slider.prototype = {
          ...
          getEventXY: function (event, targetTouchId) {
            ...
            if (event[clientXY] !== undefined) {
              return event[clientXY] * $rootScope.scaleAfterZoom;
            }
            ...
            if (targetTouchId !== undefined) {
              for (var i = 0; i < touches.length; i++) {
                if (touches[i].identifier === targetTouchId) {
                  return touches[i][clientXY] * $rootScope.scaleAfterZoom;
                }
              }
            }
            ...
            return touches[0][clientXY] * $rootScope.scaleAfterZoom;
          },
          ...
          getEventPosition: function (event, targetTouchId) {
            var sliderPos = this.sliderElem.rzsp,
              eventPos = 0;
            if (this.options.vertical) eventPos = -this.getEventXY(event, targetTouchId) + sliderPos;
      ...
      function (RzSlider) {
        ...
        return {
          ...
          link: function (scope, elem) {
            ...
            scope.$watch("shiftFilterOpen.value", function handleWatchValueChange(newValue, oldValue) {
              scope.slider.resetSlider();
            });
          },
        };
      },
  ...
  module.run([
    ...
    function ($templateCache) {
      ...
      $templateCache.put(
          ...
          '<span class="rz-pointer rz-pointer-min" ng-style=minPointerStyle style="visibility: hidden">' +
          '</span> ' +
          '<span class="rz-pointer rz-pointer-max" ng-style=maxPointerStyle style="visibility: hidden">' +
