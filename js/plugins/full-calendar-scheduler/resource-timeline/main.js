    ...
    */
    ...
    var ResourceTimelineView = /** @class */ (function (_super) {
        ...
        function ResourceTimelineView(context, viewSpec, dateProfileGenerator, parentEl) {
            ...
            _this.setResourceAreaWidth(sessionStorage.getItem('resourceAreaWidth') || _this.opt('resourceAreaWidth'));
        ...
        */
        ...
        ResourceTimelineView.prototype.setResourceAreaWidth = function (widthVal) {
            ...
            if (widthVal) {
                if (typeof widthVal === 'string' && widthVal.indexOf('px') >= 0) {
                    sessionStorage.setItem('resourceAreaWidth',widthVal);
                }
                else {
                    sessionStorage.setItem('resourceAreaWidth',`${widthVal}px`);
                }
            }
    ...
    var main = core.createPlugin({
        ...
        views: {
            resourceTimeline: {
                ...
                resourceAreaWidth: sessionStorage.getItem('resourceAreaWidth') || '30%',
