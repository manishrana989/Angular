...
JustGage = function(config) {
    ...
    if (this.config.max == this.config.min){
        this.config.max = this.config.max + 0.000000000000001;
        changed = true;
    }
    // overflow values
    if (config.value > this.config.max) {
        this.config.value = this.config.max - 1/500 * this.config.max;
        config.value = this.config.value;
        this.config.levelColors =  ['#cfcfcf', '#cfcfcf', '#cfcfcf', '#cfcfcf','#cfcfcf', '#cfcfcf', '#cfcfcf', '#cfcfcf','#cfcfcf', 'ff0000'];
    }
    if (config.value < this.config.min){
        this.config.value = this.config.min + 1/500 * this.config.min;
        config.value = this.config.value;
        this.config.levelColors =  ['#ff0000', '#cfcfcf', '#cfcfcf', '#cfcfcf','#cfcfcf', '#cfcfcf', '#cfcfcf', '#cfcfcf','#cfcfcf', 'cfcfcf'];
    }
    ...
    var texMaxTemp = this.config.max;
    if (changed == true){
        texMaxTemp = this.config.max - 0.000000000000001;
    }
    // max
    this.txtMax = this.canvas.text(this.params.maxX, this.params.maxY, texMaxTemp);
    this.txtMax. attr({
